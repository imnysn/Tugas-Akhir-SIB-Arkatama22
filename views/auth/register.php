                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('auth/register/verify'); ?>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-2" type="number" placeholder="No. HP" minlength="9" maxlength="15" min="0" name="phone_number" value="<?php echo set_value('phone_number'); ?>" required>
