...
class Pages extends CI_Controller {
    ...
    public function send_message()
    {
        ...
        else
        {
            ...
            $this->session->set_flashdata('contact_flash', 'Pesan Anda berhasil dikirimkan. Kami akan membalas dalam waktu 1x24 jam. Mohon untuk mengecek pesan Anda secara berkala!');
